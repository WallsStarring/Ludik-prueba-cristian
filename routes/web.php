...
Route::get('/2/{fecha1}/{fecha2}/{letra?}', function (Request $request, $fecha1, $fecha2, $letra = null) {
...
Route::get('/3/{idDisfraz}', function ($idDisfraz) {
...
Route::get('/4/{name}', function ($name) {
